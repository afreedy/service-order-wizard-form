...
export interface Customer_area_data_cleanBase {
  ID?: number;
  Title?: string;
  field_1?: string;
  field_2?: string;
...
export interface Customer_area_data_cleanRead extends Customer_area_data_cleanBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface Customer_area_data_cleanWrite extends Customer_area_data_cleanBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}
