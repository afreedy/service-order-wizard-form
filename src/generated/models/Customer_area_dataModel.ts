...
export interface Customer_area_dataBase {
  ID?: number;
  Title?: string;
  field_1?: string;
...
export interface Customer_area_dataRead extends Customer_area_dataBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface Customer_area_dataWrite extends Customer_area_dataBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}
