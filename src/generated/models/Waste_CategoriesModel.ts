...
export interface Waste_CategoriesBase {
  ID?: number;
  Title?: string;
...
export interface Waste_CategoriesRead extends Waste_CategoriesBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface Waste_CategoriesWrite extends Waste_CategoriesBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}
