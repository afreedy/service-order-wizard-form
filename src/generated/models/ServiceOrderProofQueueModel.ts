...
export interface ServiceOrderProofQueueBase {
  ID?: number;
  Title?: string;
...
export interface ServiceOrderProofQueueRead extends ServiceOrderProofQueueBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface ServiceOrderProofQueueWrite extends ServiceOrderProofQueueBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}
