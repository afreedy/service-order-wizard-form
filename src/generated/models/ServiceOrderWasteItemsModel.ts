...
export interface ServiceOrderWasteItemsBase {
  ID?: number;
  Title?: string;
...
export interface ServiceOrderWasteItemsRead extends ServiceOrderWasteItemsBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface ServiceOrderWasteItemsWrite extends ServiceOrderWasteItemsBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}
